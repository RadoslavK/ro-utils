...
export const RefineCalculatorInput: React.FC<Props> = ({
  ...
  const changeRefineInput = createOnChangeCallback(refineInput, onRefineInputChange);
    ...
    >
      <div>
        ...
        <NumberInput
          ...
          onChange={changeRefineInput('targetRefineLevel')}
          minValue={1}
          maxValue={10}
        />
        <DropDown<RefineType>
          ...
          onChange={changeRefineInput('refineType')}
      ...
      <div>
        ...
        <NumberInput
          label="Base cost"
          value={baseItemCost}
          onChange={changeRefineInput('baseItemCost')}
          minValue={0}
        />
